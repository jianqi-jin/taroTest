...
var Login = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Login() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Login.__proto__ || Object.getPrototypeOf(Login)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.config = {
  ...
  _createClass(Login, [{
    ...
    key: "onBtnUserClick",
    value: function onBtnUserClick(e) {
      console.log(e);
    ...
    value: function componentWillMount() {
      //获取参数
      var user = this.$router.params.user;
      this.setState({
        user: user
      });
    }
  ...
  return Login;
}(_index.Component), _class.$$events = ["onBtnUserClick"], _class.$$componentPath = "pages/user/login/login", _temp2);
